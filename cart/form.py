...
class insertProduct(forms.Form): # 新增商品
    ...
    price = forms.CharField(
        required=False,
        label="商品價格",
        widget=forms.TextInput(attrs={"placeholder": "price", "required": True}),
    )
    amount = forms.CharField(
        required=False,
        label="商品數量",
        widget=forms.TextInput(attrs={"placeholder": "amount", "required": True}),
    )
...
class delProduct(forms.Form):  # 刪除商品
    product = forms.CharField(
        required=False,
        label="商品代號",
        widget=forms.TextInput(attrs={"placeholder": "product Id", "required": True}),
    )
...
class insertCart(forms.Form):  # 新增商品至購物車
    product = forms.CharField(
        required=False,
        label="商品代號",
        widget=forms.TextInput(attrs={"placeholder": "product Id", "required": True}),
...
class delCart(forms.Form):  # 刪除購物車內的商品
    cId = forms.CharField(
        required=False,
        label="購物車代號",
        widget=forms.TextInput(
            attrs={"placeholder": "cart product Id", "required": True}
        ),
    )
...
class getCart(forms.Form):  # 客戶收到後，訂單成為已送達
    cId = forms.CharField(
        required=False,
        label="購物車代號",
        widget=forms.TextInput(
